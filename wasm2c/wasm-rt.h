...
#endif
#ifndef WASM_RT_NONCONFORMING_MEMCHECK_NONE
#define WASM_RT_NONCONFORMING_MEMCHECK_NONE 1
#endif
...
#if (WASM_RT_MEMCHECK_GUARD_PAGES + WASM_RT_MEMCHECK_BOUNDS_CHECK + WASM_RT_NONCONFORMING_MEMCHECK_NONE) > 1
#error \
    "Cannot use both WASM_RT_MEMCHECK_GUARD_PAGES and WASM_RT_MEMCHECK_BOUNDS_CHECK"

#elif (WASM_RT_MEMCHECK_GUARD_PAGES + WASM_RT_MEMCHECK_BOUNDS_CHECK + WASM_RT_NONCONFORMING_MEMCHECK_NONE) == 0
#error \
